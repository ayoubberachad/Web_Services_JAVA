...
public class BanqueWSLocator extends org.apache.axis.client.Service implements bdcc.BanqueWS {
    ...
    private java.lang.String BanqueServicePort_address = "http://localhost:8086/";
    ...
    public bdcc.BanqueService getBanqueServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            bdcc.BanqueServicePortBindingStub _stub = new bdcc.BanqueServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (bdcc.BanqueService.class.isAssignableFrom(serviceEndpointInterface)) {
                bdcc.BanqueServicePortBindingStub _stub = new bdcc.BanqueServicePortBindingStub(new java.net.URL(BanqueServicePort_address), this);
                _stub.setPortName(getBanqueServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://bdcc/", "BanqueWS");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://bdcc/", "BanqueServicePort"));
        }
